# -*- coding: utf-8 -*-
#
# metatools documentation build configuration file, created by
...
htmlhelp_basename = 'metatoolsdoc'
...
latex_documents = [
  ('index', 'metatools.tex', u'metatools Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'metatools', u'metatools Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'metatools', u'metatools Documentation',
   u'Western X', 'metatools', 'One line description of project.',
   'Miscellaneous'),
]
